"""Verhoeff checksum used on the numeric part of a farm id."""
...
def verhoeff_check_digit(number: str) -> str:
    checksum = 0
    for index, character in enumerate(reversed(number), start=1):
        checksum = _MULTIPLICATION[checksum][_PERMUTATION[index % 8][int(character)]]
